...
clone_help = """
Rose Clones are exact replicas of @TheTechXDev but with a personalized name and profile picture, ensuring enhanced performance and stability.
...
6. Send the API token to Rose via private message using `/clone [apitokenhere]`. Ensure to remove '[ ]'.
...
• /clone `[bottoken]`: Clones Rose to your provided bot. **Goes live instantly!** Make sure to remove the square brackets.
...
PS: If you need any help, feel free to ask in our support group [here.](https://t.me/MissRose_XRobot) I have created this feature with my heart, and it took a lot of time and effort. So, please don't hesitate to keep support for this feature alive.
